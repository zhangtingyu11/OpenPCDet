...
def auto_train():
    ...
    #! 添加Contra和添加LA的版本
    #* USE_GT, VAL_ACTIVATED, PROPOTION, LOWER_SCORE, HIGHER_SCORE, USE_CONTRA, USE_LA, INPUT_FEATURES
    no_gt_configs = [[False, False, 0, 0, 0, False, True, 4]]
    no_gt_lines = [66, 67, 68, 69, 70, 122, 123, 113]
    tags = ["use_la"]
    ...
    #! 使用gt的版本
    configs = [[False, False, 0, 0, 0, False, False, 4],
                [False, False, 0, 0, 0, True, True, 5],
                [True, False, 0.5, 0.6, 1.0, True, True, 5],
                [True, False, 0.5, 0.8, 1.0, True, True, 5],
                [True, False, 1.0, 0.6, 1.0, True, True, 5],
                [True, False, 1.0, 0.8, 1.0, True, True, 5]]
    line_idxs = [67, 68, 69, 70, 71, 123, 124, 114]
    tags = ["use_gt_sampling",
            ...
            "use_all_1.0_0.6_1.0",
            "use_all_1.0_0.8_1.0"]
    yaml_file = "/home/public/zty/Project/DeepLearningProject/OpenPCDet/tools/cfgs/kitti_models/second_car_clocs_contra_fusion_aug.yaml"
