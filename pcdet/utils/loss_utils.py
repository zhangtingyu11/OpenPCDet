...
class WeightedFocalLoss(nn.Module):
    ...
    def forward(self, pred: Tensor, target: Tensor, pixel_weight) -> Tensor:
        return self.focal_loss(pred, target, self.alpha, self.gamma, self.reduction, self.weight, pixel_weight)
