...
from ..roi_heads.roi_head_template import RoIHeadTemplate
import torch
import numba
import copy
...
class ClocsVoxelRCNNHead(nn.Module):
    ...
    def forward(self, data_dict):
        ...
        self.forward_ret_dict = data_dict['forward_ret_dict']
        #* 转成0~1之间
        ...
        self.forward_ret_dict['rcnn_cls'] = cls_preds
    ...
    def get_loss(self):
        cls_loss, tb_dict = self.get_box_cls_layer_loss(self.forward_ret_dict)
