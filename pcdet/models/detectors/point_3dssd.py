...
class Point3DSSD(Detector3DTemplate):
    ...
    def forward(self, batch_dict):
        ...
        if self.training:
            ...
            # score_with_no_sigmoid = self.model_cfg.POST_PROCESSING.get("SCORE_WITH_NO_SIGMOID", False)
            # pred_dicts, recall_dicts = self.post_processing(batch_dict, score_with_no_sigmoid=score_with_no_sigmoid)
